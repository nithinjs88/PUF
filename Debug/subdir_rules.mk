...
Flash.obj: ../Flash.c $(GEN_OPTS) $(GEN_HDRS)
	...
	"E:/ti2/ccsv6/tools/compiler/ti-cgt-msp430_4.4.3/bin/cl430" -vmspx --abi=eabi --data_model=restricted --use_hw_mpy=16 --include_path="E:/ti2/ccsv6/ccs_base/msp430/include" --include_path="E:/ti2/ccsv6/tools/compiler/ti-cgt-msp430_4.4.3/include" --advice:power=all -g --define=__MSP430F2618__ --diag_warning=225 --display_error_number --diag_wrap=off --printf_support=full -k --asm_listing --preproc_with_compile --preproc_dependency="Flash.pp" $(GEN_OPTS__FLAG) "$<"
